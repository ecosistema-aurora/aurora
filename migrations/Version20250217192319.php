...
final class Version20250217192319 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD type VARCHAR(20) DEFAULT NULL');
        ...
        $this->addSql("UPDATE event SET type = 'in person' WHERE type IS NULL");
